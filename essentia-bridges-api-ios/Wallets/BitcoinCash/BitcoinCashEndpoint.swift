...
private enum Constants {
    enum Path {
        ...
        static var getTrxHistory: NSString = "/third-party/bitcoin-cash/explorer-bitcoin/details/%@/transactions"
...
enum BitcoinCashEndpoint: RequestProtocol {
    ...
    var path: String {
        ...
        case .getTransactionsHistory(let address):
            return NSString(format: Constants.Path.getTrxHistory, address).description
